...
@section('content')
 <div class="container text-center">
     <div class="row justify-content-center">
         <div class="col-md-5">
             <span>
                 <p><a href="{{ route('mypage') }}">マイページ</a> > 会員情報の編集</p>
             </span>
             ...
             <form method="POST" action="{{ route('mypage') }}">
                 ...
                 <div class="form-group text-center">
                     <div class="d-flex justify-content-between text-center">
                         <label for="name" class="text-center">氏名</label>
                     </div>
                 ...
                 <div class="form-group">
                     ...
                     <div class="collapse show editUserMail">
                         <input id="email" type="text" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ $user->email }}" required autocomplete="email" autofocus placeholder="XXXXX@domein.com">
                         @error('email')
                         <span class="invalid-feedback" role="alert">
                 ...
                 <div class="form-group">
                     <div class="d-flex justify-content-between">
                         <label for="address" class="text-md-left">住所</label>
                     </div>
                     <div class="collapse show editUserPhone">
